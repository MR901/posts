...
::
    ...
    allow_edit: false        # Protect finalized posts from accidental edits
----------------------------------------------------------------------------

Tip: To reduce accidental changes in your editor, pair ``allow_edit: false`` with adding the post path to ``.cursorignore`` so protected posts don't show up in fuzzy file search.
